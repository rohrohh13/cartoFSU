...
const Nav = () => {
    ...
    const {setCurrentNav, setIsDomSelected} = useNavStore()
    ...
    return (
        <nav className={styles.navContainer}>
            ...
            <div>
                <button onClick={() => setIsDomSelected(false)}>HEXAGONE</button>
                <button onClick={() => setIsDomSelected(true)}>OUTRE-MER</button>                
            </div> 
        </nav>
    )
}
