...
const Nav = () => {
    ...
    return (
        <nav className={styles.navContainer}>
            ...
            <div>
            <button onClick={() => setIsDomSelected(false)} style={{ backgroundColor: !isDomSelected ? 'black' : 'white', color: !isDomSelected ? 'white' : 'initial' }}>HEXAGONE</button>
            <button onClick={() => setIsDomSelected(true)} style={{ backgroundColor: isDomSelected ? 'black' : 'white', color: isDomSelected ? 'white' : 'initial' }}>OUTRE-MER</button>                
            </div> 
        </nav>
    )
}
